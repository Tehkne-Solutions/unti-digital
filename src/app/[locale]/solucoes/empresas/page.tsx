...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }) {
  ...
  const content = getStaticPageContent(resolvedLocale, "companies");
  return buildMetadata({ locale: resolvedLocale, title: content.seoTitle, description: content.seoDescription, pathname: "/solucoes/empresas" });
}

export default function EmpresasPage({ params: { locale } }: { params: { locale: AppLocale } }) {
  const content = getStaticPageContent(locale, "companies");
