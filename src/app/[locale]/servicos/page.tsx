...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }) {
  ...
  const content = getStaticPageContent(resolvedLocale, "services");
  return buildMetadata({ locale: resolvedLocale, title: content.seoTitle, description: content.seoDescription, pathname: "/servicos" });
}

export default function ServicosPage({ params: { locale } }: { params: { locale: AppLocale } }) {
  const content = getStaticPageContent(locale, "services");
