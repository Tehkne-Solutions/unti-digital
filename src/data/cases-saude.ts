...
export const saudeCases: CaseSeed[] = [
  {
    id: "dr-eduardo-ursolino",
    slug: "dr-eduardo-ursolino",
    cliente: "Dr. Eduardo Ursolino",
    categoria: "saude",
    ...
    impacto:
      "Marca mais solida, leitura imediata de valor e jornada de contato preparada para reduzir friccao no agendamento.",
    resultados: [
    ...
    ordemHome: 4,
    ordemPortfolio: 4,
    heroSubtitle: "Odontologia de Alta Performance"
  },
  {
    id: "dr-alessandro-linder",
    slug: "dr-alessandro-linder",
    ...
    entrega:
      "Site institucional com blocos de autoridade, explicacao de servicos e pontos de conversao distribuidos ao longo da navegacao.",
    impacto:
      "Maior percepcao de valor, mais seguranca para o usuario e uma entrada comercial mais qualificada.",
    resultados: [
      "Narrativa medica mais clara e confiavel",
      "Contato facilitado para novos pacientes",
      "Base otimizada para busca local e reputacao digital"
    ],
    destaqueHome: false,
    ordemPortfolio: 5
  },
