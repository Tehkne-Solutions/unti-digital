...
export function Button({
  ...
  const baseStyles = "interactive-btn inline-flex items-center justify-center h-12 px-6 rounded-xl font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2";
